...
HSCore.components.HSChartMatrixJS = {
        ...
        init(t, e, i) {
            ...
            window.addEventListener("on-hs-appearance-change", (t => this._updateTheme(t.detail))), o._init()
        },
        ...
        getTheme(t, e) {
            return this.themes[t] && this.themes[t][e] || console.error(`The element '${t}' or theme '${e}' was not found in the HSChartjs theme list.`), this.themes[t][e]
        },
        getItems() {
            const t = this;
            let e = [];
        ...
        _init: function (t, e) {
            ...
            for (let t = 0; t < i.collection.length; t += 1) {
                let e, o;
                i.collection[t].hasOwnProperty("$initializedEl") || (o = i.collection[t].$el, e = i.extendOptions(o, i.collection[t].options, i.collection[t].dataSettings, t), i.backgroundColor(e), i.legend(e), i.tooltip(), i.collection[t].$initializedEl = new Chart(o, e))
            }
        },
        backgroundColor(t) {
        ...
        legend(t) {
            if (t.options.hasOwnProperty("matrixLegend")) {
                for (var e = t.data.datasets[0].data[0].v, i = t.data.datasets[0].data[0].v, o = 1; o < t.data.datasets[0].data.length; o++) t.data.datasets[0].data[o].v < e && (e = t.data.datasets[0].data[o].v), t.data.datasets[0].data[o].v > i && (i = t.data.datasets[0].data[o].v);
                ...
                a.classList.add("hs-chartjs-matrix-legend"), a.insertAdjacentHTML("beforeend", `<li class="hs-chartjs-matrix-legend-min">${e}</li>`);
                for (o = 0; o < i;) {
                    var r = (s + o) / t.options.matrixBackgroundColord.accent;
                    n.push('<li class="hs-chartjs-matrix-legend-item" style="background-color: ' + Chart.helpers.color(t.options.matrixBackgroundColord.color).alpha(r).rgbString() + '"></li>'), o += l
                }
                a.insertAdjacentHTML("beforeend", n.join("")), t.options.matrixLegend.metric && i > 100 && (i = i < 1e6 ? i / 1e3 + "k" : i / 1e6 + "kk"), a.insertAdjacentHTML("beforeend", `<li class="hs-chartjs-matrix-legend-max">${i}</li>`)
            }
        },
        tooltip() {
        ...
        extendOptions(t, e, i, o) {
            const n = (t, e, i = !1) => {
                ...
                return o(t) && o(e) ? (Object.keys(e).forEach((l => {
                    const s = t[l],
                        a = e[l];
                    Array.isArray(s) && Array.isArray(a) ? i ? (t[l] = s.map(((t, e) => a.length <= e ? t : n(t, a[e], i))), a.length > s.length && (t[l] = t[l].concat(a.slice(s.length)))) : t[l] = s.concat(a) : o(s) && o(a) ? t[l] = n(Object.assign({}, s), a, i) : t[l] = a
                })), t) : e
            };
            let l = n(this.defaults, n(i, e, !0), !0);
            return l.options = this._setTheme(l.options, t.id || o), l.options.plugins.tooltip.external = function (t) {
                var e = document.getElementById("chartjsTooltip");
                if (e || ((e = document.createElement("div")).id = "chartjsTooltip", e.style.opacity = 0, e.classList.add("hs-chartjs-tooltip-wrap"), e.classList.add("hs-chartjs-tooltip-matrix"), e.innerHTML = '<div class="hs-chartjs-tooltip"></div>', document.body.appendChild(e)), "matrix" !== l.type && 0 === t.tooltip.opacity) return e.style.opacity = 0, void e.remove();
                if (e.classList.remove("above", "below", "no-transform"), t.tooltip.yAlign ? e.classList.add(t.tooltip.yAlign) : e.classList.add("no-transform"), t.tooltip.body) {
                    ...
                    i.forEach((function (t) {
                        s += t + ", " + n.getFullYear()
                    })), s += '</header><div class="hs-chartjs-tooltip-body">', o.forEach((function (e, i) {
                        s += "<div>";
                        var o = e[0],
                            n = o,
                        ...
                        s += (l.options.plugins.tooltip.hasIndicator ? '<span class="d-inline-block rounded-circle mr-1" style="width: ' + l.options.plugins.tooltip.indicatorWidth + "; height: " + l.options.plugins.tooltip.indicatorHeight + "; background-color: " + a + '"></span>' : "") + (o.length > 3 ? n : e), s += "</div>"
                    })), s += "</div>", e.querySelector(".hs-chartjs-tooltip").innerHTML = s
                }
                var a = this._chart.canvas.getBoundingClientRect();
                e.style.opacity = 1, e.style.left = a.left + window.pageXOffset + t.tooltip.caretX - e.offsetWidth / 2 - 3 + "px", e.style.top = a.top + window.pageYOffset + t.tooltip.caretY - e.offsetHeight - 25 + "px", e.style.pointerEvents = "none", e.style.transition = l.options.plugins.tooltip.transition
            }, l
        },
        _setTheme(t, e) {
            const i = (t, e, o = !1) => {
                ...
                return n(t) && n(e) ? (Object.keys(e).forEach((l => {
                    const s = t[l],
                        a = e[l];
                    Array.isArray(s) && Array.isArray(a) ? o ? (t[l] = s.map(((t, e) => a.length <= e ? t : i(t, a[e], o))), a.length > s.length && (t[l] = t[l].concat(a.slice(s.length)))) : t[l] = s.concat(a) : n(s) && n(a) ? t[l] = i(Object.assign({}, s), a, o) : t[l] = a
                })), t) : e
            };
            let o = localStorage.getItem("hs_theme") || window.hs_config.themeAppearance.layoutSkin;
            return "auto" === o && (o = window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "default"), this.themes[e] && o !== this.defaultThemeKey ? i(t, this.themes[e][o].options, !0) : t
        },
        _updateTheme(t) {
            Object.keys(this.themes).forEach((t => {
                ...
                if (i) {
                    ...
                    i.$initializedEl.data = e.data, i.$initializedEl.options = e.options, i.$initializedEl.update()
                }
            }))
        }
    }
    ...
    , HSCore.components.HSChartJS = {
        ...
        lineMode(t, e) {
            "line" === e.type && e.data.datasets.forEach((i => {
                if (Array.isArray(i.backgroundColor)) {
                    ...
                    for (let t = 0; t < i.backgroundColor.length; t++) o.addColorStop(t, i.backgroundColor[t]);
        ...
        extendChart(t, e, i) {
            ...
            if ("line" === e.type && e.options.plugins.tooltip.lineMode) {
                var n = i.draw;
                i.draw = function (t) {
                    if (n.call(this, t), this.tooltip._active && this.tooltip._active.length) {
                        ...
                        if (a && !document.querySelector("#chartjsTooltip #chartjsTooltipLine") && a.insertAdjacentHTML("beforeend", '<div id="chartjsTooltipLine"></div>'), !i) return;
                        i.style.top = t.clientHeight / 2 - i.clientHeight + "px", n && (n.style.top = `${-(o(i).top-o(t).top)+l}px`);
                        let r = document.querySelector(".hs-chartjs-tooltip");
                        if (i.offsetLeft + i.clientWidth > t.offsetLeft + t.clientWidth - 100) {
                            if (!r) return;
                            r.classList.remove("hs-chartjs-tooltip-right"), r.classList.add("hs-chartjs-tooltip-left")
                        } else {
                            if (!r) return;
                            r.classList.add("hs-chartjs-tooltip-right"), r.classList.remove("hs-chartjs-tooltip-left")
                        }
                        n && (n.style.position = "absolute", n.style.width = "2px", n.style.height = t.clientHeight - s + "px", n.style.backgroundColor = e.options.plugins.tooltip.lineWithLineColor, n.style.left = 0, n.style.transform = "translateX(-50%)", n.style.zIndex = 0, n.style.transition = "100ms")
                    }
                        ...
                        y: {
                            ticks: {
                                callback: (t, e, i) => {
                                    ...
                                    return o && t > 100 && (t = t < 1e6 ? t / 1e3 + "k" : t / 1e6 + "kk"), n && s ? n + t + s : n ? n + t : s ? t + s : t
                                }
                            }
                        }
                    },
                    ...
                    plugins: {
                        tooltip: {
                            external: function (e) {
                                ...
                                if (i || ((i = document.createElement("div")).id = "chartjsTooltip", i.style.opacity = 0, i.classList.add("hs-chartjs-tooltip-wrap"), i.innerHTML = '<div class="hs-chartjs-tooltip"></div>', this.options.lineMode ? t.closest(".chartjs-custom").appendChild(i) : document.body.appendChild(i)), 0 === e.tooltip.opacity) return i.style.opacity = 0, void i.parentNode.removeChild(i);
                                if (i.classList.remove("above", "below", "no-transform"), e.tooltip.yAlign ? i.classList.add(e.tooltip.yAlign) : i.classList.add("no-transform"), e.tooltip.body) {
                                    ...
                                    o.forEach((t => {
                                    ...
                                    })), s += '</header><div class="hs-chartjs-tooltip-body">', n.forEach(((t, i) => {
                                        s += "<div>";
                                        var o = t[0],
                                            n = o,
                                        ...
                                        s += (this.options.hasIndicator ? '<span class="d-inline-block rounded-circle me-1" style="width: ' + this.options.indicatorWidth + "; height: " + this.options.indicatorHeight + "; background-color: " + l + '"></span>' : "") + this.options.prefix + (o.length > 3 ? n : t) + this.options.postfix, s += "</div>"
                                    })), s += "</div>", i.querySelector(".hs-chartjs-tooltip").innerHTML = s
                                }
                                var a = this._chart.canvas.getBoundingClientRect();
                                i.style.opacity = 1, this.options.lineMode ? i.style.left = e.tooltip.caretX + "px" : i.style.left = a.left + window.pageXOffset + e.tooltip.caretX - i.offsetWidth / 2 - 3 + "px", this.options.lineMode || (i.style.top = a.top + window.pageYOffset + e.tooltip.caretY - i.offsetHeight - 25 + "px"), i.style.pointerEvents = "none", i.style.transition = this.options.transition
                            }
                        }
                    }
                }
        ...
        destroy(t) {
            ...
            if (e) {
                ...
                if (e.$el.parentNode.replaceChild(i, e.$el), "number" == typeof t) this.collection.splice(t, 1);
                else {
        ...
        _getSubject(t) {
            let e = null;
            return e = "number" == typeof t ? this.collection[t] : this.collection.find((e => e.id === t)), e
        },
        _setTheme(t, e) {
            const i = (t, e, o = !1) => {
                t = (t => {
            ...
            let o = localStorage.getItem("hs_theme") || window.hs_config.themeAppearance.layoutSkin;
            return "auto" === o && (o = window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "default"), this.themes[e] && o !== t.defaultThemeKey ? i(t, this.themes[e][o], !0) : t
        },
        _updateTheme(t) {
            Object.keys(this.themes).forEach((t => {
                let e = this.collection.findIndex((e => e.id === t));
                ...
                if (i) {
                    let e = this.extendOptions(i.$el, i.options, i.dataSettings, t);
                    i.$initializedEl.data = e.data, i.$initializedEl.options = e.options, this.lineMode(i.$el, e), i.$initializedEl.update()
                }
            }))
        },
        _init: function (t, e) {
            ...
            for (let t = 0; t < i.collection.length; t += 1) {
                let e, o;
                i.collection[t].hasOwnProperty("$initializedEl") || (o = i.collection[t].$el, e = i.extendOptions(o, i.collection[t].options, i.collection[t].dataSettings, t), i.lineMode(o, e), i.collection[t].$initializedEl = new Chart(o, e), i.extendChart(o, e, i.collection[t].$initializedEl))
            }
        }
    }
    /*  * Circles wrapper
    ...
    , HSCore.components.HSClipboard = {
        ...
        _init: function (t, e) {
            ...
            for (let e = 0; e < i.collection.length; e += 1) {
                ...
                o = i.collection[e].options, n = i.collection[e].$el, o.contentTarget && i.setShortcodes(n, o), n.closest(".modal") && (o.container = n.closest(".modal")), i.collection[e].$initializedEl = new ClipboardJS(n, o), "tooltip" === o.type ? o.instanceTooltip = bootstrap.Tooltip.getOrCreateInstance(n) : "popover" === o.type && (o.instancePopover = new bootstrap.Popover(n));
                const l = function () {
                    o.instanceTooltip.tip.style.display = "none", n.setAttribute("data-bs-original-title", o.title), o.instanceTooltip.setContent(), setTimeout((() => {
                        o.instanceTooltip.tip.style.display = "block"
                    }), 100), n.removeEventListener("mouseleave", l)
                };
                i.collection[e].$initializedEl.on("success", (() => {
                    if (o.successText || o.successClass) {
                        if (o.successText && ("tooltip" === o.type ? (n.setAttribute("data-bs-original-title", o.successText), o.instanceTooltip.setContent(), o.instanceTooltip.show(), n.addEventListener("mouseleave", l)) : "popover" === o.type ? (t.setAttribute("data-bs-original-title", o.successText), o.instancePopover.show(), n.addEventListener("mouseleave", (() => {
                                n.setAttribute("data-bs-original-title", o.title), o.instancePopover.hide()
                            }))) : (n.lastChild.nodeValue = " " + o.successText + " ", setTimeout((function () {
                                n.lastChild.nodeValue = o.defaultText
                            }), 800))), o.successClass)
                            if (o.classChangeTarget) {
                                let t = document.querySelector(o.classChangeTarget);
                                if (!t) return;
                                t.classList.remove(o.defaultClass), t.classList.add(o.successClass), setTimeout((function () {
                                    t.classList.remove(o.successClass), t.classList.add(o.defaultClass)
                                }), 800)
                            } else n.classList.remove(o.defaultClass), n.classList.add(o.successClass), setTimeout((function () {
                                n.classList.remove(o.successClass), n.classList.add(o.defaultClass)
                            }), 800);
                        if ("cut" === o.action) {
        ...
        addToCollection(t, e, i) {
            e = Object.assign({
                shortcodes: {}
            }, this.defaults, t.hasAttribute(this.dataAttributeName) ? JSON.parse(t.getAttribute(this.dataAttributeName)) : {}, e), this.collection.push({
                $el: t,
                id: i || null,
    ...
    , HSCore.components.HSFlatpickr = {
        ...
        _init: function () {
            ...
            for (let e = 0; e < t.collection.length; e += 1) {
                let i, o, n;
                t.collection[e].hasOwnProperty("$initializedEl") || (i = t.collection[e].$el, o = t.collection[e].options, n = i, o.appendTo && (o.appendTo = document.querySelector(o.appendTo)), n instanceof HTMLInputElement || (n = i.querySelector(".flatpickr-input")), n && (i.style.width = 12 * n.value.length + "px"), t.collection[e].$initializedEl = flatpickr(i, o))
            }
        }
    }
    /*
    ...
    , HSCore.components.HSFullCalendar = {
        ...
        _init: function () {
            const t = this;
            for (let e = 0; e < t.collection.length; e += 1) t.collection[e].hasOwnProperty("$initializedEl") || (t.collection[e].$initializedEl = new FullCalendar.Calendar(t.collection[e].$el, t.collection[e].options), t.collection[e].$initializedEl.render())
        }
    },
    /*
     * HSMask Plugin
    ...
    , HSCore.components.HSJsVectorMap = {
        ...
        _init: function () {
            ...
            for (let e = 0; e < t.collection.length; e += 1) {
                ...
                t.collection[e].$initializedEl = new jsVectorMap(o), window.addEventListener("resize", (() => {
        ...
        initializeHover: function (t, e, i) {
            ...
            n.addEventListener("keydown", (s => {
                if (40 === s.which) s.preventDefault(), o.searchMenuShow(t, e, i), (a = i.list.querySelector(".active")) ? a.nextElementSibling && ((r = a.nextElementSibling).classList.add("active"), l.classList.remove("active"), l = r, i.list.offsetHeight < r.getBoundingClientRect().top && (i.list.scrollTop = r.getBoundingClientRect().top + i.list.scrollTop)) : (l = i.list.firstChild).classList.add("active");
                else if (38 === s.which) {
                    var a, r;
                    if (s.preventDefault(), a = i.list.querySelector(".active")) {
                        if (a.previousElementSibling)(r = a.previousElementSibling).classList.add("active"), l.classList.remove("active"), l = r, 0 > r.getBoundingClientRect().top && (i.list.scrollTop = r.getBoundingClientRect().top + i.list.scrollTop - i.list.offsetHeight)
        ...
        searchMenuHide: function (t, e, i) {
            ...
            e.searchMenuOutsideClose && document.addEventListener("click", (() => {
                o.helpers.fadeOut(i.list, e.searchMenuDelay), e.clearSearchInput && (n.value = "")
    ...
    , HSCore.components.HSNoUISlider = {
        ...
        updateChart: function (t, e) {
            ...
            if (e.foreground_target_el && t.get().length <= 2) {
                ...
                l.style.width = `${t.parentElement.clientWidth}px`, l.style.marginLeft = -t.parentElement.clientWidth / 100 * i + "px"
            }
        },
    ...
    , HSCore.components.HSSortable = {
        ...
        _init: function () {
            const t = this;
            for (let e = 0; e < t.collection.length; e += 1) t.collection[e].hasOwnProperty("$initializedEl") || (t.collection[e].$initializedEl = new Sortable(t.collection[e].$el, t.collection[e].options))
        }
    },
    /*
     * Tagify wrapper
    ...
    HSCore.components.HSTagify = {
        ...
        _init: function () {
            ...
            for (let e = 0; e < t.collection.length; e += 1) {
                let i, o, n;
                t.collection[e].hasOwnProperty("$initializedEl") || (i = t.collection[e].options, o = t.collection[e].$el, t.collection[e].$initializedEl = new Tagify(o, i), i.clearBtnSelector && (n = document.querySelector(i.clearBtnSelector), n.addEventListener("click", (function () {
                    t.collection[e].$initializedEl.removeAllTags.bind(t.collection[e].$initializedEl)
                }))), i.hasManualList && (t._renderSuggestionsList(o, t.collection[e].$initializedEl), t.collection[e].$initializedEl.on("add", (function () {
                    1 === t.collection[e].$initializedEl.suggestedListItems.length && (t.collection[e].$initializedEl.DOM.dropdown.innerHTML = "", t.collection[e].$initializedEl.styles.display = "none")
                })), t.collection[e].$initializedEl.on("remove", (function () {
                    0 === t.collection[e].$initializedEl.suggestedListItems.length && (t.collection[e].$initializedEl.DOM.dropdown.styles.display = "none")
                }))))
            }
        },
    ...
    HSCore.components.HSTomSelect = {
        ...
        addToCollection(t, e, i) {
            ...
            this.collection.push({
                ...
                id: i || null,
                options: Object.assign({}, o.defaults, t.hasAttribute(o.dataAttributeName) ? JSON.parse(t.getAttribute(o.dataAttributeName)) : {}, e)
                // options: Object.assign({}, o.defaults, t.hasAttribute(o.dataAttributeName) ? t.getAttribute(o.dataAttributeName) : {}, e)
            })
        },
        getItems() {
            const t = this;
