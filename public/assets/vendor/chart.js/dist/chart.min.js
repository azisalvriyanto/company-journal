...
! function (t, e) {
    ...
    function Ae(t, e = [""], i = t, s, n = (() => t[0])) {
        ...
        return new Proxy(o, {
            ...
            get: (i, s) => Ie(i, s, (() => function (t, e, i, s) {
                let n;
                for (const o of e)
                    if (n = Ne(Re(o, t), i), ut(n)) return Ee(t, n) ? Ve(i, s, t, n) : n
            }(s, e, t, i))),
    ...
    function Ti(t, e, i, s, n) {
        ...
        return Ai(t, i, e, (function (i, a, r) {
            (n || we(i, t.chartArea, 0)) && i.inRange(e.x, e.y, s) && o.push({
                element: i,
                datasetIndex: a,
                index: r
            })
    ...
    var qi = {
        ...
        update(t, e, i, s) {
            ...
            const n = ui(t.options.layout.padding),
                ...
                r = function (t) {
                    const e = function (t) {
                        ...
                        i = Vi(e.filter((t => t.box.fullSize)), !0),
                        s = Vi(Fi(e, "left"), !0),
                        n = Vi(Fi(e, "right")),
                        o = Vi(Fi(e, "top"), !0),
                        a = Vi(Fi(e, "bottom")),
            ...
            const f = Object.assign({
                ...
                g = Wi(l.concat(h), d);
            Yi(r.fullSize, f, d, g), Yi(l, f, d, g), Yi(h, f, d, g) && Yi(l, f, d, g),
                function (t) {
    ...
    class Ns extends As {
        ...
        getContext(t) {
            ...
            return this.$context || (this.$context = mi(this.chart.getContext(), {
                scale: this,
                type: "scale"
            }))
        }
    ...
    class gn {
        ...
        render() {
            !1 !== this.notifyPlugins("beforeRender", {
                cancelable: !0
            }) && (a.has(this) ? this.attached && !a.running(this) && a.start(this) : (this.draw(), ln({
                chart: this
            })))
        }
        draw() {
        ...
        getContext() {
            return this.$context || (this.$context = mi(null, {
                chart: this,
                type: "chart"
            }))
        }
    ...
    class Cn extends Os {
        ...
        _calculateBarValuePixels(t) {
            ...
            } = this, o = s || 0, a = this.getParsed(t), r = a._custom, l = Mn(r);
            let h, c, d = a[e.axis],
                u = 0,
    ...
    function io(t) {
        const e = to(t),
            ...
            o = function (t, e, i) {
                ...
                } = t.getProps(["enableBorderRadius"]), n = t.options.borderRadius, o = di(n), a = Math.min(e, i), r = t.borderSkipped, l = s || q(n);
                return {
            ...
            for (const t of s) {
                ...
                for (const e of h) {
                    ...
                    for (const t of r) a.push({
                        ...
                        target: e,
                        start: {
                            [i]: go(l, s, "start", Math.max)
                        },
                        end: {
                            [i]: go(l, s, "end", Math.min)
                        }
                    })
                }
            }
    ...
    class Ao extends As {
        ...
        _draw() {
            const {
                ...
                align: a,
                labels: r
            } = t, l = yt.color, h = bi(t.rtl, this.left, this.width), c = fi(r.font), {
                color: d,
                padding: u
            } = r, f = c.size, g = f / 2;
            let p;
            ...
            const {
                ...
                boxHeight: b,
                itemHeight: x
            } = Oo(r, f), _ = this.isHorizontal(), y = this._computeTitleHeight();
            p = _ ? {
    ...
    function jo(t, e, i) {
        ...
        return {
            xAlign: i.xAlign || e.xAlign || No(t, e, i, s),
            yAlign: s
        }
    }
    ...
    class Xo extends As {
        ...
        _positionChanged(t, e) {
            const {
                ...
                caretY: s,
                options: n
            } = this, o = zo[n.position].call(this, t, e);
    ...
    Zo.id = "category", Zo.defaults = {
        ticks: {
            callback: Zo.prototype.getLabelForValue
        }
    };
    class Qo extends Ns {
        constructor(t) {
        ...
        buildTicks() {
            ...
            const s = function (t, e) {
                ...
                for (m && (d && v !== o ? (i.push({
                        value: o
                    }), v < o && P++, jt(Math.round((v + P * k) * y) / y, o, Jo(o, _, t)) && P++) : v < o && P++); P < M; ++P) i.push({
                    value: Math.round((v + P * k) * y) / y
                });
                return b && d && w !== a ? i.length && jt(i[i.length - 1].value, a, Jo(a, _, t)) ? i[i.length - 1].value = a : i.push({
                    value: a
                }) : b && w !== a || i.push({
                    value: w
                }), i
