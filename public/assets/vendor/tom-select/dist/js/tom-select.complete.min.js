...
! function (e, t) {
    ...
    const r = {
        ...
        c = e => e.normalize("NFKD").replace(n, "").toLowerCase().replace(l, (function (e) {
            return r[e]
        })),
        d = (e, t = "|") => {
        ...
        u = e => {
            ...
            var t = []
            return u(e.substring(1)).forEach((function (i) {
                var s = i.slice(0)
        ...
        h = e => {
            void 0 === o && (o = (e => {
                ...
                s = Object.keys(t).sort(((e, t) => t.length - e.length)), i = new RegExp("(" + p(s) + "[̀-ͯ·ʾ]*)", "gu")
                var n = {}
                return s.sort(((e, t) => e.length - t.length)).forEach((e => {
                    var i = u(e).map((e => (e = e.map((e => t.hasOwnProperty(e) ? p(t[e]) : e)), d(e, ""))))
                    n[e] = d(i)
                })), n
            })(a))
        ...
        b = (e, t) => "number" == typeof e && "number" == typeof t ? e > t ? 1 : e < t ? -1 : 0 : (e = c(e + "").toLowerCase()) > (t = c(t + "").toLowerCase()) ? 1 : t > e ? -1 : 0
    class w {
        constructor(e, t) {
        ...
        tokenize(e, t, i) {
            ...
            const s = [],
                n = e.split(/\s+/)
            var o
            return i && (o = new RegExp("^(" + Object.keys(i).map(m).join("|") + "):(.*)$")), n.forEach((e => {
                let i, n = null,
                    r = null
                o && (i = e.match(o)) && (n = i[1], e = i[2]), e.length > 0 && (r = this.settings.diacritics ? h(e) : m(e), t && (r = "\\b" + r)), s.push({
                    string: e,
        ...
        _getSortFunction(e) {
            ...
            if (r)
                for (t = 0, i = r.length; t < i; t++)(e.query || "$score" !== r[t].field) && l.push(r[t])
            if (e.query) {
            ...
            if (d) {
                if (1 === d) {
                    const e = l[0].field,
                        t = a[0]
                    return function (i, s) {
                        return t * b(c(e, i), c(e, s))
                    }
                }
                return function (e, t) {
                    var i, s, n
                    for (i = 0; i < d; i++)
                        if (n = l[i].field, s = a[i] * b(c(n, e), c(n, t))) return s
                    return 0
                }
            }
            return null
        ...
        prepareSearch(e, t) {
            ...
            if (O(s, "sort"), O(s, "sort_empty"), s.fields) {
                O(s, "fields")
                const e = []
                s.fields.forEach((t => {
                    "string" == typeof t && (t = {
    ...
    const _ = e => {
        ...
        I = e => "string" == typeof e && e.indexOf("<") > -1,
        C = (e, t) => {
    ...
    const N = e => null == e ? null : H(e),
        H = e => "boolean" == typeof e ? e ? "1" : "0" : e + "",
        R = e => (e + "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;"),
        z = (e, t) => {
            var i
            return function (s, n) {
                var o = this
        ...
        Q = (e, t) => !!t && (!!t[e] && 1 === (t.altKey ? 1 : 0) + (t.ctrlKey ? 1 : 0) + (t.shiftKey ? 1 : 0) + (t.metaKey ? 1 : 0)),
        G = (e, t) => {
    ...
    function J(e, t) {
        ...
        return "select" === d ? (h = O.options, g = {}, v = 1, f = e => {
            ...
            var t, i, s;
            "optgroup" === (u = e.tagName.toLowerCase()) ? ((s = f(t = e))[a] = s[a] || t.getAttribute("label") || "", s[c] = s[c] || v++, s[r] = s[r] || t.disabled, O.optgroups.push(s), i = s[c], y(t.children, (e => {
                m(e, i)
            }))) : "option" === u && m(e)
        }))) : (() => {
            const t = e.getAttribute(s)
            if (t) O.options = JSON.parse(t), y(O.options, (e => {
                O.items.push(e[o])
            }))
            else {
                var r = e.value.trim() || ""
    ...
    class Y extends(function (e) {
        ...
        constructor(e, t) {
            ...
            const n = J(s, t)
            this.settings = n, this.input = s, this.tabIndex = s.tabIndex || 0, this.is_select_tag = "select" === s.tagName.toLowerCase(), this.rtl = /rtl/i.test(i), this.inputId = G(s, "tomselect-" + X), this.isRequired = s.required, this.sifter = new w(this.options, {
            ...
            "function" != typeof o && ("string" == typeof o && (o = new RegExp(o)), o instanceof RegExp ? n.createFilter = e => o.test(e) : n.createFilter = e => this.settings.duplicates || !this.options[e]),
                this.initializePlugins(n.plugins), this.setupCallbacks(), this.setupTemplates()
            const r = _("<div>"),
                l = _("<div>"),
                a = this._render("dropdown"),
                c = _('<div role="listbox" tabindex="-1">'),
                d = this.input.getAttribute("class") || "",
                p = n.mode
            var u
            if (A(r, n.wrapperClass, d, p), A(l, n.controlClass), W(r, l), A(a, n.dropdownClass, p), n.copyClassesToDropdown && A(a, d), A(c, n.dropdownContentClass), W(a, c), _(n.dropdownParent || r).appendChild(a), I(n.controlInput)) {
                u = _(n.controlInput)
                y(["autocorrect", "autocapitalize", "autocomplete"], (e => {
                    s.getAttribute(e) && T(u, {
                        [e]: s.getAttribute(e)
                    })
                })), u.tabIndex = -1, l.appendChild(u), this.focus_node = u
            } else n.controlInput ? (u = _(n.controlInput), this.focus_node = u) : (u = _("<input/>"), this.focus_node = l)
        ...
        setup() {
            ...
            const p = G(a, e.inputId + "-ts-control"),
                u = "label[for='" + (e => e.replace(/['"\\]/g, "\\$&"))(e.inputId) + "']",
            ...
            if (o.style.width = l.style.width, e.plugins.names.length) {
                ...
                A([o, s], t)
            }(null === t.maxItems || t.maxItems > 1) && e.is_select_tag && T(l, {
                multiple: "multiple"
            }), t.placeholder && T(i, {
                placeholder: t.placeholder
            }), !t.splitOn && t.delimiter && (t.splitOn = new RegExp("\\s*" + m(t.delimiter) + "+\\s*")), t.load && t.loadThrottle && (t.load = z(t.load, t.loadThrottle)), e.control_input.type = l.type, K(s, "mouseenter", (t => {
                var i = L(t.target, "[data-selectable]", s)
                i && e.onOptionHover(t, i)
            }), {
                capture: !0
            }), K(s, "click", (t => {
                const i = L(t.target, "[data-selectable]")
                i && (e.onOptionSelect(t, i), B(t, !0))
            })), K(r, "click", (t => {
                var s = L(t.target, "[data-ts-item]", r)
                s && e.onItemSelect(t, s) ? B(t, !0) : "" == i.value && (e.onClick(), B(t, !0))
            })), K(a, "keydown", (t => e.onKeyDown(t))), K(i, "keypress", (t => e.onKeyPress(t))), K(i, "input", (t => e.onInput(t))), K(a, "resize", (() => e.positionDropdown()), c), K(a, "blur", (t => e.onBlur(t))), K(a, "focus", (t => e.onFocus(t))), K(i, "paste", (t => e.onPaste(t)))
            const v = t => {
            ...
            K(document, "mousedown", v), K(window, "scroll", f, c), K(window, "resize", f, c), K(window, "mousemove", O, c), this._destroy = () => {
                document.removeEventListener("mousedown", v), window.removeEventListener("mousemove", O), window.removeEventListener("scroll", f), window.removeEventListener("resize", f), h && h.removeEventListener("click", g)
            }, this.revertSettings = {
                innerHTML: l.innerHTML,
                tabIndex: l.tabIndex
            }, l.tabIndex = -1, l.insertAdjacentElement("afterend", e.wrapper), e.sync(!1), t.items = [], delete t.optgroups, delete t.options, K(l, "invalid", (t => {
                e.isValid && (e.isValid = !1, e.isInvalid = !0, e.refreshState())
            })), e.updateOriginalInput(), e.refreshItems(), e.close(!1), e.inputState(), e.isSetup = !0, l.disabled ? e.disable() : e.enable(), e.on("change", this.onChange), A(l, "tomselected", "ts-hidden-accessible"), e.trigger("initialize"), !0 === t.preload && e.preload()
        }
        setupOptions(e = [], t = []) {
            this.addOptions(e), y(t, (e => {
        ...
        onMouseDown() {}
        onChange() {
            C(this.input, "input"), C(this.input, "change")
        }
        onPaste(e) {
            var t = this
            t.isInputHidden || t.isLocked ? B(e) : t.settings.splitOn && setTimeout((() => {
                var e = t.inputValue()
                if (e.match(t.settings.splitOn)) {
                    var i = e.trim().split(t.settings.splitOn)
                    y(i, (e => {
                        e = N(e), this.options[e] ? t.addItem(e) : t.createItem(e)
                    }))
                }
            }), 0)
        }
        onKeyPress(e) {
            ...
            if (!t.isLocked) {
                ...
                return t.settings.create && "multi" === t.settings.mode && i === t.settings.delimiter ? (t.createItem(), void B(e)) : void 0
            }
            B(e)
        }
        onKeyDown(e) {
            ...
            if (t.ignoreHover = !0, t.isLocked) 9 !== e.keyCode && B(e)
                ...
                switch (e.keyCode) {
                    case 65:
                        if (Q(q, e) && "" == t.control_input.value) return B(e), void t.selectAll()
                        break
                    case 27:
                        return t.isOpen && (B(e, !0), t.close()), void t.clearActiveItems()
                    case 40:
                    ...
                    case 38:
                        ...
                        return void B(e)
                    case 13:
                        return void(t.canSelect(t.activeOption) ? (t.onOptionSelect(e, t.activeOption), B(e)) : (t.settings.create && t.createItem() || document.activeElement == t.control_input && t.isOpen) && B(e))
                    case 37:
                        return void t.advanceSelection(-1, e)
                    case 39:
                        return void t.advanceSelection(1, e)
                    case 9:
                        return void(t.settings.selectOnTab && (t.canSelect(t.activeOption) && (t.onOptionSelect(e, t.activeOption), B(e)), t.settings.create && t.createItem() && B(e)))
                    case 8:
                    case 46:
                        return void t.deleteSelection(e)
                }
                t.isInputHidden && !Q(q, e) && B(e)
            }
        }
        onInput(e) {
            var t = this
        ...
        onOptionSelect(e, t) {
            var i, s = this
            t.parentElement && t.parentElement.matches("[data-disabled]") || (t.classList.contains("create") ? s.createItem(null, !0, (() => {
        ...
        onItemSelect(e, t) {
            var i = this
            return !i.isLocked && "multi" === i.settings.mode && (B(e), i.setActiveItem(t, e), !0)
        }
        canLoad(e) {
        ...
        loadCallback(e, t) {
            const i = this
            i.loading = Math.max(i.loading - 1, 0), i.lastQuery = null, i.clearActiveOption(), i.setupOptions(e, t), i.refreshOptions(i.isFocused && !i.isInputHidden), i.loading || x(i.wrapper, i.settings.loadingClass), i.trigger("load", e, t)
        }
        preload() {
        ...
        setTextboxValue(e = "") {
            ...
            t.value !== e && (t.value = e, C(t, "update"), this.lastValue = e)
        }
        getValue() {
        ...
        setActiveItem(e, t) {
            ...
            if ("single" !== a.settings.mode) {
                ...
                if ("click" === (i = t && t.type.toLowerCase()) && Q("shiftKey", t) && a.activeItems.length) {
                    ...
                    B(t)
                } else "click" === i && Q(q, t) || "keydown" === i && Q("shiftKey", t) ? e.classList.contains("active") ? a.removeActiveItem(e) : a.setActiveItemClass(e) : (a.clearActiveItems(), a.setActiveItemClass(e))
        ...
        setActiveItemClass(e) {
            ...
            i && x(i, "last-active"), A(e, "active last-active"), t.trigger("item_select", e), -1 == t.activeItems.indexOf(e) && t.activeItems.push(e)
        }
        removeActiveItem(e) {
            var t = this.activeItems.indexOf(e)
            this.activeItems.splice(t, 1), x(e, "active")
        }
        clearActiveItems() {
            x(this.activeItems, "active"), this.activeItems = []
        }
        setActiveOption(e, t = !0) {
            e !== this.activeOption && (this.clearActiveOption(), e && (this.activeOption = e, T(this.focus_node, {
                "aria-activedescendant": e.getAttribute("id")
            }), T(e, {
                "aria-selected": "true"
            }), A(e, "active"), t && this.scrollToOption(e)))
        }
        scrollToOption(e, t) {
            if (!e) return
        ...
        clearActiveOption() {
            this.activeOption && (x(this.activeOption, "active"), T(this.activeOption, {
                "aria-selected": null
            })), this.activeOption = null, T(this.focus_node, {
        ...
        selectAll() {
            ...
            t.length && (e.hideInput(), e.close(), e.activeItems = t, y(t, (t => {
                e.setActiveItemClass(t)
            })))
        }
        inputState() {
            var e = this
            e.control.contains(e.control_input) && (T(e.control_input, {
                placeholder: e.settings.placeholder
            }), e.activeItems.length > 0 || !e.isFocused && e.settings.hidePlaceholder && e.items.length > 0 ? (e.setTextboxValue(), e.isInputHidden = !0) : (e.settings.hidePlaceholder && e.items.length > 0 && T(e.control_input, {
                placeholder: ""
        ...
        search(e) {
            ...
            if (e !== n.lastQuery ? (n.lastQuery = e, i = n.sifter.search(e, Object.assign(o, {
                    score: s
                })), n.currentResults = i) : i = Object.assign({}, n.currentResults), n.settings.hideSelected)
                for (t = i.items.length - 1; t >= 0; t--) {
                    let e = N(i.items[t].id)
        ...
        refreshOptions(e = !0) {
            ...
            var g, v = this,
                ...
                m = v.search(f),
                O = null,
                b = v.settings.shouldOpen || !1,
                w = v.dropdown_content
            for (v.activeOption && (c = v.activeOption.dataset.value, d = v.activeOption.closest("[data-group]")), n = m.items.length, "number" == typeof v.settings.maxOptions && (n = Math.min(n, v.settings.maxOptions)), n > 0 && (b = !0), t = 0; t < n; t++) {
                let e = m.items[t].id,
                    n = v.options[e],
                    l = v.getOption(e, !0)
                for (v.settings.hideSelected || l.classList.toggle("selected", v.items.includes(e)), o = n[v.settings.optgroupField] || "", i = 0, s = (r = Array.isArray(o) ? o : [o]) && r.length; i < s; i++) o = r[i], v.optgroups.hasOwnProperty(o) || (o = ""), u.hasOwnProperty(o) || (u[o] = document.createDocumentFragment(), h.push(o)), i > 0 && (l = l.cloneNode(!0), T(l, {
                    id: n.$id + "-clone-" + i,
                    "aria-selected": null
                }), l.classList.add("ts-cloned"), x(l, "active")), O || c != e || (d ? d.dataset.group === o && (O = l) : O = l), u[o].appendChild(l)
            }
            this.settings.lockOptgroupOrder && h.sort(((e, t) => (v.optgroups[e] && v.optgroups[e].$order || 0) - (v.optgroups[t] && v.optgroups[t].$order || 0))), l = document.createDocumentFragment(), y(h, (e => {
            ...
            })), w.innerHTML = "", W(w, l), v.settings.highlight && (g = w.querySelectorAll("span.highlight"), Array.prototype.forEach.call(g, (function (e) {
                var t = e.parentNode
                t.replaceChild(e.firstChild, e), t.normalize()
            })), m.query.length && m.tokens.length && y(m.tokens, (e => {
                V(w, e.regex)
            })))
            var _ = e => {
                let t = v.render(e, {
            ...
            if (v.loading ? _("loading") : v.settings.shouldLoad.call(v, f) ? 0 === m.items.length && _("no_results") : _("not_loading"), (a = v.canCreate(f)) && (p = _("option_create")), v.hasOptions = m.items.length > 0 || a, b) {
                if (m.items.length > 0) {
                    if (!O && "single" === v.settings.mode && v.items.length && (O = v.getOption(v.items[0])), !w.contains(O)) {
                        let e = 0
                        p && !v.settings.addPrecedence && (e = 1), O = v.selectable()[e]
                    }
                } else p && (O = p)
                e && !v.isOpen && (v.open(), v.scrollToOption(O, "auto")), v.setActiveOption(O)
        ...
        updateOption(e, t) {
            ...
            if (t.$order = t.$order || i.options[o].$order, delete i.options[o], i.uncacheValue(r), i.options[r] = t, l) {
                if (i.dropdown_content.contains(l)) {
                    ...
                    j(l, e), i.activeOption === l && i.setActiveOption(e)
                }
                l.remove()
            }
            a && (-1 !== (n = i.items.indexOf(o)) && i.items.splice(n, 1, r), s = i._render("item", t), a.classList.contains("active") && A(s, "active"), j(a, s)), i.lastQuery = null
        }
        removeOption(e, t) {
            const i = this
            e = H(e), i.uncacheValue(e), delete i.userOptions[e], delete i.options[e], i.lastQuery = null, i.trigger("option_remove", e), i.removeItem(e, t)
        }
        clearOptions(e) {
        ...
        getItem(e) {
            ...
            var t = N(e)
            return null !== t ? this.control.querySelector(`[data-value="${U(t)}"]`) : null
        }
        addItems(e, t) {
            var i = this,
        ...
        addItem(e, t) {
            M(this, t ? [] : ["change", "dropdown_close"], (() => {
                var i, s
                const n = this,
                    o = n.settings.mode,
                    r = N(e)
        ...
        removeItem(e = null, t) {
            ...
            s = P(e), e.remove(), e.classList.contains("active") && (n = i.activeItems.indexOf(e), i.activeItems.splice(n, 1), x(e, "active")), i.items.splice(s, 1), i.lastQuery = null, !i.settings.persist && i.userOptions.hasOwnProperty(o) && i.removeOption(o, t), s < i.caretPos && i.setCaret(i.caretPos - 1), i.updateOriginalInput({
                silent: t
        ...
        createItem(e = null, t = !0, i = (() => {})) {
            ...
            return s = "function" == typeof n.settings.create ? n.settings.create.call(this, e, l) : {
        ...
        updateOriginalInput(e = {}) {
            ...
            if (t.is_select_tag) {
                ...
                function o(i, s, o) {
                    return i || (i = _('<option value="' + R(s) + '">' + R(o) + "</option>")), i != n && t.input.append(i), e.push(i), (i != n || r > 0) && (i.selected = !0), i
                }
                t.input.querySelectorAll("option:checked").forEach((e => {
                    e.selected = !1
                })), 0 == t.items.length && "single" == t.settings.mode ? o(n, "", "") : t.items.forEach((n => {
                    if (i = t.options[n], s = i[t.settings.labelField] || "", e.includes(i.$option)) {
                        o(t.input.querySelector(`option[value="${U(n)}"]:not(:checked)`), n, s)
        ...
        open() {
            var e = this
            e.isLocked || e.isOpen || "multi" === e.settings.mode && e.isFull() || (e.isOpen = !0, T(e.focus_node, {
                "aria-expanded": "true"
            }), e.refreshState(), S(e.dropdown, {
                visibility: "hidden",
                display: "block"
            }), e.positionDropdown(), S(e.dropdown, {
                visibility: "visible",
                display: "block"
        ...
        close(e = !0) {
            var t = this,
                i = t.isOpen
            e && (t.setTextboxValue(), "single" === t.settings.mode && t.items.length && t.hideInput()), t.isOpen = !1, T(t.focus_node, {
                "aria-expanded": "false"
            }), S(t.dropdown, {
                display: "none"
        ...
        advanceSelection(e, t) {
            var i, s, n = this
            n.rtl && (e *= -1), n.inputValue().length || (Q(q, t) || Q("shiftKey", t) ? (s = (i = n.getLastActive(e)) ? i.classList.contains("active") ? n.getAdjacent(i, e, "item") : i : e > 0 ? n.control_input.nextElementSibling : n.control_input.previousElementSibling) && (s.classList.contains("active") && n.removeActiveItem(i), n.setActiveItemClass(s)) : n.moveCaret(e))
        }
        moveCaret(e) {}
        getLastActive(e) {
        ...
        destroy() {
            var e = this,
                t = e.revertSettings
            e.trigger("destroy"), e.off(), e.wrapper.remove(), e.dropdown.remove(), e.input.innerHTML = t.innerHTML, e.input.tabIndex = t.tabIndex, x(e.input, "tomselected", "ts-hidden-accessible"), e._destroy(), delete e.input.tomselect
        }
        render(e, t) {
        ...
        _render(e, t) {
            var i, s, n = ""
            const o = this
            return "option" !== e && "item" != e || (n = H(t[o.settings.valueField])), null == (s = o.settings.render[e].call(this, t, R)) || (s = _(s), "option" === e || "option_create" === e ? t[o.settings.disabledField] ? T(s, {
                "aria-disabled": "true"
            }) : T(s, {
                "data-selectable": ""
            }) : "optgroup" === e && (i = t.group[o.settings.optgroupValueField], T(s, {
                "data-group": i
            }), t.group[o.settings.disabledField] && T(s, {
                "data-disabled": ""
            })), "option" !== e && "item" !== e || (T(s, {
                "data-value": n
            }), "item" === e ? (A(s, o.settings.itemClass), T(s, {
                "data-ts-item": ""
            })) : (A(s, o.settings.optionClass), T(s, {
                role: "option",
                id: t.$id
            }), o.options[n].$div = s))), s
        }
    ...
    return Y.define("change_listener", (function () {
        K(this.input, "change", (() => {
            this.sync()
        }))
    })), Y.define("checkbox_options", (function () {
        var e = this,
            t = e.onOptionSelect
        ...
        e.hook("after", "setupTemplates", (() => {
            ...
            if (n.classList.contains("selected")) return n.classList.remove("selected"), e.removeItem(n.dataset.value), e.refreshOptions(), void B(s, !0)
            t.call(e, s, n), i(n)
        }))
    })), Y.define("clear_button", (function (e) {
        const t = this,
            i = Object.assign({
    ...
    })), Y.define("caret_position", (function () {
        var e = this
        e.hook("instead", "setCaret", (t => {
            ...
            if (i) {
                const s = P(i)
                e.setCaret(t > 0 ? s + 1 : s), e.setActiveItem(), x(i, "last-active")
            } else e.setCaret(e.caretPos + t)
        }))
    })), Y.define("dropdown_input", (function () {
        const e = this
        e.settings.shouldOpen = !0, e.hook("before", "setup", (() => {
            e.focus_node = e.control, A(e.control_input, "dropdown-input")
            ...
            e.control_input.addEventListener("keydown", (t => {
                switch (t.keyCode) {
                    case 27:
                        return e.isOpen && (B(t, !0), e.close()), void e.clearActiveItems()
                    case 9:
            ...
            })), K(e.control_input, "blur", (() => e.onBlur())), e.hook("before", "close", (() => {
                e.isOpen && e.focus_node.focus({
                    preventScroll: !0
                })
            }))
        }))
    })), Y.define("input_autogrow", (function () {
        var e = this
        e.on("initialize", (() => {
            ...
            s(), e.on("update item_add item_remove", s), K(i, "input", s), K(i, "keyup", s), K(i, "blur", s), K(i, "update", s)
        }))
    })), Y.define("no_backspace_delete", (function () {
        var e = this,
            t = e.deleteSelection
        this.hook("instead", "deleteSelection", (i => !!e.activeItems.length && t.call(e, i)))
    })), Y.define("no_active_items", (function () {
        this.hook("instead", "setActiveItem", (() => {})), this.hook("instead", "selectAll", (() => {}))
    })), Y.define("optgroup_columns", (function () {
        var e = this,
            t = e.onKeyDown
        e.hook("instead", "onKeyDown", (i => {
            var s, n, o, r
            if (!e.isOpen || 37 !== i.keyCode && 39 !== i.keyCode) return t.call(e, i)
            e.ignoreHover = !0, r = L(e.activeOption, "[data-group]"), s = P(e.activeOption, "[data-selectable]"), r && (r = 37 === i.keyCode ? r.previousSibling : r.nextSibling) && (n = (o = r.querySelectorAll("[data-selectable]"))[Math.min(o.length - 1, s)]) && e.setActiveOption(n)
        }))
        ...
        var i = this
        if (t.append) {
            var s = '<a href="javascript:void(0)" class="' + t.className + '" tabindex="-1" title="' + R(t.title) + '">' + t.label + "</a>"
            i.hook("after", "setupTemplates", (() => {
                var e = i.settings.render.item
                i.settings.render.item = (t, n) => {
                    var o = _(e.call(i, t, n)),
                        r = _(s)
                    return o.appendChild(r), K(r, "mousedown", (e => {
                        B(e, !0)
                    })), K(r, "click", (e => {
                        B(e, !0), i.isLocked || i.shouldDelete([o], e) && (i.removeItem(o), i.refreshOptions(!1), i.inputState())
                    })), o
                }
            }))
        }
    ...
    })), Y.define("virtual_scroll", (function () {
        const e = this,
            t = e.canLoad,
        ...
        e.setNextUrl = (e, t) => {
            ...
            l ? o && t.length > 0 && (o.dataset.value = t[0][e.settings.valueField]) : e.clearOptions(d), s.call(e, t, i), l = !1
            ...
            c(t) ? (i = e.render("loading_more", {
                ...
                query: t
            })), i && (A(i, e.settings.optionClass), n.append(i))
        })), e.on("initialize", (() => {
