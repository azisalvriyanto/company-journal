    ...
    public function index(Request $request)
    {
        if (request()->ajax()) {
            ...
            ->editColumn('name', function ($query) {
                return '<span class="badge ' . $query->background_color . ' ' . $query->font_color . '">' . $query->name . '</span>';
            })
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="datatableMore-' . $query->id . '">
                                ...
                                <a class="dropdown-item" href="' . route('statuses.edit', $query->id) . '">
            ...
            ->setRowAttr([
                ...
                'data-url' => function($query) {
                    return route('statuses.show', $query->id);
                },
                'data-name' => function($query) {
                    return $query->name;
                },
                'data-background-color' => function($query) {
                    return $query->background_color;
                },
                'data-font-color' => function($query) {
                    return $query->font_color;
                },
            ])
