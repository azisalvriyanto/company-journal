        ...
        <div class="row justify-content-between align-items-center flex-grow-1">
            ...
            <div class="col-auto">
                <div class="dropdown me-2">
                    ...
                    <button type="button" class="btn btn-white btn-sm dropdown-toggle" id="datatableOwnerGroupExportDropdown"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="bi-download me-2"></i> Export
                    </button>

                    <div class="dropdown-menu dropdown-menu-sm-end" aria-labelledby="datatableOwnerGroupExportDropdown"
                        style="">
    ...
    <div class="datatable-custom">
        <table id="datatableOwnerGroup"
            ...
            data-hs-datatables-options='{
                ...
                "deferRender": true,
                "info": {
                    "totalQty": "#datatableOwnerGroupWithPaginationInfoTotalQty"
                },
                "pagination": "datatableOwnerGroupWithPagination",
                "dom": "Bfrtip",
                "buttons": [
                    {
                        "extend": "copy",
                ...
                <tr>
                    ...
                    <th>
                        <div class="tom-select-custom">
                            <select class="js-select js-datatable-filter form-select form-select-sm form-select-borderless p-0" autocomplete="off" data-target-column-index="2" data-target-table="datatableOwnerGroup" data-hs-tom-select-options='{
        ...
        <div class="row justify-content-center justify-content-sm-between align-items-sm-center">
            <div class="col-sm mb-2 mb-sm-0">
                <div class="d-flex justify-content-center justify-content-sm-start align-items-center">
                    ...
                    <span id="datatableOwnerGroupWithPaginationInfoTotalQty"></span>
                </div>
            </div>

            <div class="col-sm-auto">
                <div class="d-flex justify-content-center justify-content-sm-end">
                    <nav id="datatableOwnerGroupWithPagination" aria-label="Activity pagination"></nav>
                </div>
            </div>
        </div>
    </div>
...
<script>
    (function () {
        ...
        const datatableOwnerGroup = HSCore.components.HSDatatables.getItem('datatableOwnerGroup');
                    ...
                    destroy: {
                        ...
                        action: async function () {
                            ...
                            .done(async function(res) {
                                if (res.status == 200) {
                                    datatableOwnerGroup.ajax.reload(null, false);
