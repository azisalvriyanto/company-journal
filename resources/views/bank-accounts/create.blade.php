            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    <div class="col-sm-12">
                        ...
                        <input id="name" name="name" type="text" class="form-control" placeholder="Enter your account name" value="" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-sm-12">
                        ...
                        <input id="account-number" name="account_number" type="text" class="form-control" placeholder="Enter your account number" value="" autocomplete="off">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    (function () {
        ...
        $(document).on('click', '.btn-create', async function (e) {
            const thisButton    = $(this);
            const url           = `{{ route('payments.bank-accounts.index') }}`
                                    ...
                                    await $.confirm({
                                        ...
                                        buttons: {
                                            ...
                                            edit: {
                                                ...
                                                action: function () {
                                                    window.location.replace(`{{ route('payments.bank-accounts.index') }}/${res.data.id}/edit`);
                                                }
                                            },
                                        },
                                    });
