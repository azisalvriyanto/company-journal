...
<li class="list-inline-item">
    <a class="list-separator-link" href="{{ route('operation-types.create') }}">Create Operation Type</a>
</li>
@endsection
...
<script>
    (function () {
        ...
        $(document).on('click', '.btn-create', async function (e) {
            const thisButton    = $(this);
            const url           = `{{ route('operation-types.index') }}`
                                    ...
                                    await $.confirm({
                                        ...
                                        buttons: {
                                            ...
                                            edit: {
                                                ...
                                                action: function () {
                                                    window.location.replace(`{{ route('operation-types.index') }}/${res.data.id}/edit`);
                                                }
                                            },
                                        },
                                    });
