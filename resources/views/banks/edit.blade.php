...
<li class="list-inline-item">
    <a class="list-separator-link" href="{{ route('payments.banks.show', $query->id) }}">{{ $query->name }}</a>
</li>
<li class="list-inline-item">
    <a class="list-separator-link" href="{{ route('payments.banks.edit', $query->id) }}">Edit</a>
</li>
@endsection
    ...
    <div class="col-lg-12 mb-3 mb-lg-0">
        <div class="card mb-3 mb-lg-5">
            <div class="card-header">
                <h4 class="card-header-title">Bank information</h4>
            </div>
            ...
            <div class="card-body">
                            ...
                            <span class="col-8 col-sm-9 ms-0">
                                <span class="text-dark">
                                    ...
                                    <i class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="Bank availability switch toggler."></i>
                                </span>
                            </span>
                ...
                <div class="row mb-4">
                    <div class="col-sm-12">
                        ...
                        <input id="short-name" name="short_name" type="text" class="form-control" placeholder="" value="{{ $query->short_name }}" autocomplete="off">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    (function () {
        ...
        $(document).on('click', '.btn-save', async function (e) {
            const thisButton    = $(this);
            const listNote      = '';
            const url           = `{{ route('payments.banks.show', $query->id) }}`
