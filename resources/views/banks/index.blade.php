                ...
                <tr>
                    ...
                    <th>
                        <div class="tom-select-custom">
                            <select class="js-select js-datatable-filter form-select form-select-sm form-select-borderless p-0" autocomplete="off" data-target-column-index="3" data-target-table="datatablePaymentMethod" data-hs-tom-select-options='{
