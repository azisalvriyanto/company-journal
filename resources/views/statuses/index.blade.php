...
<div class="card mb-3 mb-lg-5">
    <div class="card-header">
        <div class="row justify-content-between align-items-center flex-grow-1">
            <div class="col-md">
                <h4 class="card-header-title">Statuses</h4>
            </div>
            ...
            <div class="col-auto">
                <div class="dropdown me-2">
                    ...
                    <button type="button" class="btn btn-white btn-sm dropdown-toggle" id="datatableStatusExportDropdown"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="bi-download me-2"></i> Export
                    </button>

                    <div class="dropdown-menu dropdown-menu-sm-end" aria-labelledby="datatableStatusExportDropdown"
                        style="">
    ...
    <div class="datatable-custom">
        <table id="datatableStatus"
            ...
            data-hs-datatables-options='{
                ...
                "deferRender": true,
                "info": {
                    "totalQty": "#datatableStatusWithPaginationInfoTotalQty"
                },
                "pagination": "datatableStatusWithPagination",
                "dom": "Bfrtip",
                "buttons": [
                    {
                        "extend": "copy",
                ...
                <tr>
                    ...
                    <th>
                        <div class="tom-select-custom">
                            <select class="js-select js-datatable-filter form-select form-select-sm form-select-borderless p-0" autocomplete="off" data-target-column-index="2" data-target-table="datatableStatus" data-hs-tom-select-options='{
        ...
        <div class="row justify-content-center justify-content-sm-between align-items-sm-center">
            <div class="col-sm mb-2 mb-sm-0">
                <div class="d-flex justify-content-center justify-content-sm-start align-items-center">
                    ...
                    <span id="datatableStatusWithPaginationInfoTotalQty"></span>
                </div>
            </div>

            <div class="col-sm-auto">
                <div class="d-flex justify-content-center justify-content-sm-end">
                    <nav id="datatableStatusWithPagination" aria-label="Activity pagination"></nav>
                </div>
            </div>
        </div>
    </div>
...
<script>
    (function () {
        ...
        const datatableStatus = HSCore.components.HSDatatables.getItem('datatableStatus');
