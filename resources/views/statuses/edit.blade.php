...
<li class="list-inline-item">
    <a class="list-separator-link" href="{{ route('statuses.show', $query->id) }}">{{ $query->name }}</a>
</li>
<li class="list-inline-item">
    <a class="list-separator-link" href="{{ route('statuses.edit', $query->id) }}">Edit</a>
</li>
@endsection
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-6 mb-4">
                        ...
                        <input id="background-color" name="background_color" type="text" class="form-control" placeholder="" value="{{ $query->background_color }}" autocomplete="off">
                    </div>

                    <div class="col-sm-6 mb-4">
                        <label for="font-color" class="form-label">Font Color</label>

                        <input id="font-color" name="font_color" type="text" class="form-control" placeholder="" value="{{ $query->font_color }}" autocomplete="off">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    (function () {
        ...
        $(document).on('click', '.btn-save', async function (e) {
            const thisButton    = $(this);
            const listNote      = '';
            const url           = `{{ route('statuses.show', $query->id) }}`
