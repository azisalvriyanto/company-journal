...
<li class="list-inline-item">
    <a class="list-separator-link" href="{{ route('dashboards.index') }}">Dashboard</a>
</li>
@endsection
            ...
            <div class="card-body">
                ...
                <ul class="list-group list-group-flush list-group-no-gutters">
                    ...
                    <li class="list-group-item">
                        <div class="d-flex">
                            <div class="flex-shrink-0">
                                <img class="avatar avatar-xs avatar-4x3" src="{{ asset('assets/svg/brands/capsule-icon.svg') }}" alt="Image Description">
                            </div>
                    ...
                    <li class="list-group-item">
                        <div class="d-flex">
                            <div class="flex-shrink-0">
                            <img class="avatar avatar-xs avatar-4x3" src="{{ asset('assets/svg/brands/mailchimp-icon.svg') }}" alt="Image Description">
                                </div>
                            <div class="flex-grow-1 ms-3">
                            <div class="row align-items-center">
                                <div class="col">
...
<script>
    ...
    document.querySelectorAll('.js-datatable-filter').forEach(function (item) {
        item.addEventListener('change', function (e) {
            ...
            HSCore.components.HSDatatables.getItem(targetTable).column(targetColumnIndex).search(elVal !== 'null' ?
            elVal : '').draw()
        });
    });
</script>
