...
<li class="list-inline-item">
    <a class="list-separator-link" href="{{ route('sales-orders.edit', $query->id) }}">Edit</a>
</li>
@endsection
            ...
            await $.confirm({
                ...
                buttons: {
                    ...
                    okay: {
                        ...
                        btnClass: 'btn-secondary',
                        action: async function () {
                            history.back() ?? window.location.replace(`{{ route('sales-orders.show', $query->id) }}`);
                        }
                    },
                }
            });
                                    ...
                                    await $.confirm({
                                        ...
                                        buttons: {
                                            show: {
                                                ...
                                                btnClass: 'btn-primary',
                                                action: function () {
                                                    window.location.replace(`{{ route('sales-orders.show', $query->id) }}`)
                                                }
                                            },
                                            close: {
                                                text: 'Still Edit',
