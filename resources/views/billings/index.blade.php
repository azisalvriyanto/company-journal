...
<li class="list-inline-item">
    <a class="list-separator-link" href="{{ route('operating-cost-transactions.index') }}">Billings</a>
</li>
@endsection
...
<div class="card mb-3 mb-lg-5">
    <div class="card-header">
        <div class="row justify-content-between align-items-center flex-grow-1">
            <div class="col-md">
                <h4 class="card-header-title">Billings</h4>
            </div>

            <div class="col-auto">
                <div class="dropdown me-2">
                    <a class="btn btn-primary btn-sm" href="{{ route('operating-cost-transactions.create') }}">
                        <i class="bi-clipboard-plus-fill me-2"></i> Create
                    </a>

                    <button type="button" class="btn btn-white btn-sm dropdown-toggle" id="datatableBillingExportDropdown"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="bi-download me-2"></i> Export
                    </button>

                    <div class="dropdown-menu dropdown-menu-sm-end" aria-labelledby="datatableBillingExportDropdown"
                        style="">
    ...
    <div class="table-responsive datatable-custom">
        <table id="datatableBilling"
            ...
            data-hs-datatables-options='{
                ...
                "deferRender": true,
                "info": {
                    "totalQty": "#datatableBillingWithPaginationInfoTotalQty"
                },
                "pagination": "datatableBillingWithPagination",
                "dom": "Bfrtip",
                "buttons": [
                    {
                        "extend": "copy",
        ...
        <div class="row justify-content-center justify-content-sm-between align-items-sm-center">
            <div class="col-sm mb-2 mb-sm-0">
                <div class="d-flex justify-content-center justify-content-sm-start align-items-center">
                    ...
                    <span id="datatableBillingWithPaginationInfoTotalQty"></span>
                </div>
            </div>

            <div class="col-sm-auto">
                <div class="d-flex justify-content-center justify-content-sm-end">
                    <nav id="datatableBillingWithPagination" aria-label="Activity pagination"></nav>
                </div>
            </div>
        </div>
    </div>
        ...
        $(document).on('click', '.datatable-btn-destroy', async function (e) {
            ...
            <table class="table table-sm table-borderless">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="p-0">Supplier</td>
                        <td class="p-0 text-center">:</td>
                        <td class="p-0">${thisTr.data('supplier-name')}</td>
                    </tr>
                    <tr>
                        <td class="p-0">Total Bill</td>
                        <td class="p-0 text-center">:</td>
                        <td class="p-0">${thisTr.data('total-bill')}</td>
                    </tr>
                </tbody>
            </table>
            `;
                    ...
                    destroy: {
                        ...
                        action: async function () {
                            ...
                            .done(async function(res) {
                                if (res.status == 200) {
                                    datatableBilling.ajax.reload(null, false);
