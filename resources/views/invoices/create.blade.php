...
<li class="list-inline-item">
    <a class="list-separator-link" href="{{ route('invoices.create') }}">Create Invoice</a>
</li>
@endsection
    ...
    <div class="col-lg-12 mb-3 mb-lg-0">
        <div class="card mb-3 mb-lg-5">
            <div class="card-header">
                <h4 class="card-header-title">Invoice information</h4>
            </div>
...
<script>
    (function () {
        ...
        $(document).on('click', '.btn-create', async function (e) {
            const thisButton    = $(this);
            const url           = `{{ route('invoices.index') }}`
                                    ...
                                    await $.confirm({
                                        ...
                                        buttons: {
                                            ...
                                            edit: {
                                                ...
                                                action: function () {
                                                    window.location.replace(`{{ route('invoices.index') }}/${res.data.id}/edit`);
                                                }
                                            },
                                        },
                                    });
