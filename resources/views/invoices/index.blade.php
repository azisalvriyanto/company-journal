        ...
        <div class="row justify-content-between align-items-center flex-grow-1">
            ...
            <div class="col-auto">
                <div class="dropdown me-2">
                    ...
                    <button type="button" class="btn btn-white btn-sm dropdown-toggle" id="datatableInvoiceExportDropdown"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="bi-download me-2"></i> Export
                    </button>

                    <div class="dropdown-menu dropdown-menu-sm-end" aria-labelledby="datatableInvoiceExportDropdown"
                        style="">
    ...
    <div class="table-responsive datatable-custom">
        <table id="datatableInvoice"
            ...
            data-hs-datatables-options='{
                ...
                "deferRender": true,
                "info": {
                    "totalQty": "#datatableInvoiceWithPaginationInfoTotalQty"
                },
                "pagination": "datatableInvoiceWithPagination",
                "dom": "Bfrtip",
                "buttons": [
                    {
                        "extend": "copy",
                ...
                <tr>
                    ...
                    <th>
                        <div class="tom-select-custom">
                            <select class="js-select js-datatable-filter form-select form-select-sm form-select-borderless p-0" autocomplete="off" data-target-column-index="10" data-target-table="datatableInvoice" data-hs-tom-select-options='{
        ...
        <div class="row justify-content-center justify-content-sm-between align-items-sm-center">
            <div class="col-sm mb-2 mb-sm-0">
                <div class="d-flex justify-content-center justify-content-sm-start align-items-center">
                    ...
                    <span id="datatableInvoiceWithPaginationInfoTotalQty"></span>
                </div>
            </div>

            <div class="col-sm-auto">
                <div class="d-flex justify-content-center justify-content-sm-end">
                    <nav id="datatableInvoiceWithPagination" aria-label="Activity pagination"></nav>
                </div>
            </div>
        </div>
    </div>
        ...
        $(document).on('click', '.datatable-btn-destroy', async function (e) {
            ...
            <table class="table table-sm table-borderless">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="p-0">Total Invoice</td>
                        <td class="p-0 text-center">:</td>
                        <td class="p-0">${thisTr.data('total-invoice')}</td>
                    </tr>
                </tbody>
            </table>
            `;
