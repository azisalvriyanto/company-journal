...
<li class="list-inline-item">
    <a class="list-separator-link" href="{{ route('purchase-orders.create') }}">Create Purchase Order</a>
</li>
@endsection
                                    ...
                                    await $.confirm({
                                        ...
                                        buttons: {
                                            ...
                                            edit: {
                                                ...
                                                action: function () {
                                                    window.location.replace(`{{ route('purchase-orders.index') }}/${res.data.id}/edit`);
                                                }
                                            },
                                        },
                                    });
