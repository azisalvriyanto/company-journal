...
<div class="card mb-3 mb-lg-5">
    <div class="card-header">
        <div class="row justify-content-between align-items-center flex-grow-1">
            <div class="col-md">
                <h4 class="card-header-title">Purchase Orders</h4>
            </div>

            <div class="col-auto">
                <div class="dropdown me-2">
                    <a class="btn btn-primary btn-sm" href="{{ route('purchase-orders.create') }}">
                        <i class="bi-clipboard-plus-fill me-2"></i> Create
                    </a>

                    <button type="button" class="btn btn-white btn-sm dropdown-toggle" id="datatablePurchaseOrderExportDropdown"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="bi-download me-2"></i> Export
                    </button>

                    <div class="dropdown-menu dropdown-menu-sm-end" aria-labelledby="datatablePurchaseOrderExportDropdown"
                        style="">
    ...
    <div class="table-responsive datatable-custom">
        <table id="datatablePurchaseOrder"
            ...
            data-hs-datatables-options='{
                ...
                "isResponsive": false,
                "isShowPaging": false,
                "entries": "#datatablePurchaseOrderEntries",
                "deferRender": true,
                "info": {
                    "totalQty": "#datatablePurchaseOrderWithPaginationInfoTotalQty"
                },
                "pagination": "datatablePurchaseOrderWithPagination",
                "dom": "Bfrtip",
                "buttons": [
                    {
                        "extend": "copy",
        ...
        <div class="row justify-content-center justify-content-sm-between align-items-sm-center">
            <div class="col-sm mb-2 mb-sm-0">
                <div class="d-flex justify-content-center justify-content-sm-start align-items-center">
                    ...
                    <span id="datatablePurchaseOrderWithPaginationInfoTotalQty"></span>
                </div>
            </div>

            <div class="col-sm-auto">
                <div class="d-flex justify-content-center justify-content-sm-end">
                    <nav id="datatablePurchaseOrderWithPagination" aria-label="Activity pagination"></nav>
                </div>
            </div>
        </div>
    </div>
    ...
    (function () {
        ...
        HSCore.components.HSDatatables.init('.js-datatable', {
            select: {
                ...
                classMap: {
                    checkAll: '#datatablePurchaseOrderCheckAll',
                    counter: '#datatablePurchaseOrderCounter',
                    counterInfo: '#datatablePurchaseOrderCounterInfo'
                }
            },
            language: {
                processing: `
        ...
        $(document).on('click', '.datatable-btn-destroy', async function (e) {
            ...
            <table class="table table-sm table-borderless">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="p-0">Vendor</td>
                        <td class="p-0 text-center">:</td>
                        <td class="p-0">${thisTr.data('vendor-name')}</td>
                    </tr>
                    <tr>
                        <td class="p-0">Total Purchase</td>
                        <td class="p-0 text-center">:</td>
                        <td class="p-0">${thisTr.data('total-purchase')}</td>
                    </tr>
                </tbody>
            </table>
            `;
