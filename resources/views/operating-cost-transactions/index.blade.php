@extends('layouts.app')
@section('title', 'Operating Cost Transactions')

@section('list-separator')
<li class="list-inline-item">
    <a class="list-separator-link" href="{{ route('payments.payment-terms.index') }}">Operating Cost Transactions</a>
</li>
@endsection
...
<div class="card mb-3 mb-lg-5">
    <div class="card-header">
        <div class="row justify-content-between align-items-center flex-grow-1">
            <div class="col-md">
                <h4 class="card-header-title">Operating Cost Transactions</h4>
            </div>

            <div class="col-auto">
                <div class="dropdown me-2">
                    <a class="btn btn-primary btn-sm" href="{{ route('payments.payment-terms.create') }}">
        ...
        $(document).on('click', '.datatable-btn-destroy', async function (e) {
            ...
            <table class="table table-sm table-borderless">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="p-0">Total Price</td>
                        <td class="p-0 text-center">:</td>
                        <td class="p-0">${thisTr.data('total-price')}</td>
                    </tr>
                </tbody>
            </table>
            `;
